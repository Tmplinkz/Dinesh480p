...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    f'-vf "drawtext=fontfile=font.ttf:fontsize={size[0]}:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:t=5:box=1:boxcolor=black@0.5:boxborderw=6:text={name[0]}" '
